...
A modern, feature-rich game launcher designed for _UNDERTALE_ and _Deltarune_ Alternate Universe (AU) games. Built with Tauri, Vue 3, and Vite, it provides a unified interface to manage, play, and share your favorite AU games.
...
- **Retro-Themed UI**: Inspired by _UNDERTALE_, the design features a pixel-art font and iconic symbols for an immersive experience.
